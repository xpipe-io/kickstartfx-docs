...
While KickstartFX obviously uses JavaFX for the user interface, there are still a lot of possibilities on how exactly any kind of node/control should be instantiated and handled in the codebase.
...
Comps are a very basic system to create components for your user interface. If you don't like it or using something else, you can do so without problem. It's just that the existing pages like the preferences page uses them. Unless you want to heavily modify this page, there isn't any issue here.
...
This can be achieved with the **CompAugment** class, which allows you
