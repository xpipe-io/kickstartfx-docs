...
In addition to these icons, some installers like .msi or .pkg allow the ability for custom branding during the installation process. You can configure the images used in the **dist/msi** and **dist/pkg/resources** directories.