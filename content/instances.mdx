...
When the first application instance starts up, it will create the pipe/socket and listen to any messages. If that file already exists, this is interpreted as another instance already running, and the application will communicate the startup message to this instance and quit.
