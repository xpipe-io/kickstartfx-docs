...
The only thing to take care of is to not use a JDK which uses [JEP493](https://openjdk.org/jeps/493) where the JDK it does not contain any jmods. The jlink/jpackage plugin does not support these JDKs yet, hopefully in the future it will.
