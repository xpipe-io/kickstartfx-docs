...
This custom Windows shutdown hook in the class **AppWindowsShutdown** also takes care of special events, for example, when an .msi application installer requests the closure of the running application.
