...
description: Running your application in different modes
---
...
- Window mode is not supported because JavaFX is missing libraries to function? You can still run your app using the background operation mode and perform error handling
